...
export const sortByStatus = (arr) => {
    return arr.sort((a, b) => a.status > b.status ? -1 : b.status > a.status ? 1 : 0)
};

export const sortByCandidateLastName = (arr) => {
    return arr.sort((a, b) => a.candidate.last_name > b.candidate.last_name ? 1 : b.candidate.last_name > a.candidate.last_name ? -1 : 0)
};
