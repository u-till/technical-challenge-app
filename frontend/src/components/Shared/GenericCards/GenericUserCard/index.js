...
import {
    ...
    getAllUsersAction, resendUserValidationAction,
...
import {GenericSpinnerSmall} from "../../GenericSpinner";
        ...
        <>
            {isUserEditing ? (
                ...
                <UserCard>
                    ...
                    <RoundGreyButton onClick={resendEmailHandler} data-tip="Resend Verification Email">
