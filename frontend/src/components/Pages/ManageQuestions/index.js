...
const Questions = ({getAllQuestionsAction, allQuestions, targetQuestion, targetQuestionTips, updateQuestionAction, resetTargetQuestion}) => {
    ...
    const searchedQuestions = allQuestions ? allQuestions.filter((question) => question.name.toLowerCase().indexOf(search.toLowerCase()) !== -1) : null;
            ...
            <ManageQuestionsContainer>
                ...
                <ManageContainer>
                    ...
                    <BrowseContainer>
                        ...
                        <QuestionList>
                            {allQuestions === null ? <GenericSpinner/> :
                                allQuestions.length > 0 ? renderQuestions(searchedQuestions)
